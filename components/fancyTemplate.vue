<template>
    <div class="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-neutral-900 p-6">
        <div
            ...
            <div
                class="flex-shrink-0 flex items-center justify-center w-full md:w-72 bg-gradient-to-br from-blue-600 to-indigo-700 dark:from-indigo-900 dark:to-blue-800 p-8">
            ...
            <div
                class="flex flex-col flex-grow min-w-0 p-8 text-left text-gray-800 dark:text-white md:max-w-[calc(100%-18rem)]">
                ...
                <h1 class="text-4xl font-extrabold mb-2 leading-tight tracking-tight text-center sm:text-left">
                    {{ config.profileName }}
                </h1>

                <p v-if="config.profileDescription"
                    class="text-gray-600 dark:text-gray-300 mb-6 max-w-2xl leading-relaxed text-center sm:text-left">

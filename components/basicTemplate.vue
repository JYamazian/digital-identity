<template>
    <div class="min-h-screen flex flex-col items-center justify-center text-center p-6 bg-gray-50 text-gray-800 dark:bg-neutral-800 dark:text-white"
        ...
        <div class="w-full max-w-3xl rounded-2xl shadow-xl p-8 bg-white/10 dark:bg-black/10 backdrop-blur-md backdrop-saturate-150 border border-white/20 dark:border-white/10 text-white dark:text-gray-200 flex flex-col items-center justify-center text-center gap-6">

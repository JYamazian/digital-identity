<template>
  <div
    class="min-h-[100dvh] flex items-center justify-center bg-gray-50 text-gray-900 dark:bg-neutral-800 dark:text-neutral-200 p-4 sm:p-6"
    :style="config.imageCover ? backgroundStyle : {}"
  >
    <div
      class="flex flex-col items-center text-center gap-8 w-full max-w-3xl"
      :class="{
    ...
    >
      <Head>
        ...
        <Meta
          name="description"
          :content="String(config.metaDescription)"
        />
        <Link
          rel="icon"
          type="image/png"
      ...
      <img
        :src="config.profileImage as string"
        :alt="config.profileName as string"
      ...
      <p
        ...
        class="text-base sm:text-lg max-w-xl"
      >
